let getvalue = (id) => {
  ...
  async function fetchPrices() {
    try {
      ...
      const goldPricePerOunceEUR = goldPricePerOunceUSD * usdToEUR;
  
      // Convert price per ounce to price per gram
      const goldPricePerGramEUR = (goldPricePerOunceEUR / 34.5).toFixed(2);
  
      // Nisab values
      goldNisabValue = (goldPricePerGramEUR * 87.48).toFixed(2);
  ...
  let calculate = () => {
    ...
    if (amt_eligible > 0) {
        ...
        donateButton.href = "https://buy.stripe.com/aEU9ExeY1bT6dmE4gh";
